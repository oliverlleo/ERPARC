...
def run(playwright):
    ...
    # The login page is the first to be visible
    ...
    # Take a screenshot
    page.screenshot(path="jules-scratch/verification/01_accounts_payable_tab.png")

    # Change the report type to "Análise de Atraso"
    page.locator("#relatorio-pagar-tipo").select_option("analise-atraso")
    page.screenshot(path="jules-scratch/verification/02_analise_atraso.png")

    # Change the report type to "Previsão de Desembolsos"
    page.locator("#relatorio-pagar-tipo").select_option("previsao-desembolsos")
    page.screenshot(path="jules-scratch/verification/03_previsao_desembolsos.png")

    # Change the report type to "Análise de Despesas por Categoria"
    page.locator("#relatorio-pagar-tipo").select_option("analise-despesas")
    page.screenshot(path="jules-scratch/verification/04_analise_despesas.png")
